				...
				<div style="display: table-row; height: 100%;">
					<div class="adminmenubar">
						<div class="stickythingy">
							...
							<div style="text-align: center; padding: 30px; font-size: 10px;"><?php echo uilang("Developed by") ?><br><a target="_blank" class="textlink" style="color: lime;" href="https://webappdev.my.id/">https://webappdev.my.id/</a><br><br>My Web:<br><a href="https://ahmadsyaifuddin-99.github.io" class="textlink" style="color: lime;">https://ahmadsyaifuddin-99.github.io</a></div>
						</div>
					</div>
